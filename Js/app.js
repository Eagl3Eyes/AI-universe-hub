...
const DisplayLoadTools = (details) => {
    ...
    details.forEach(detail => {
        ...
        <div class="card h-100">
            <img src="${detail.image}" class="card-img-top p-3 h-75 rounded">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <p class="card-text"><i class="bi bi-calendar2-week-fill fa-solid fa-calendar-days"></i> ${published_in}</p>
                    <i onclick="LoadToolsDetails('${id}')" class="fa-solid fa-arrow-right fw-semibold" style="cursor: pointer; color: #EB5757;" data-bs-toggle="modal" data-bs-target="#featuresDetails"></i>
                </div>
            </div>
        </div>   
        `;
...
const DisplayLoadToolsDetails = (data) => {
    ...
    modalImage.innerHTML = `
        <img src="${data.image_link[0]}" class="card-img-top h-75 rounded"  alt="">
    `;
